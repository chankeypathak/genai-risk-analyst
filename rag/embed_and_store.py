...
import re
def load_and_chunk_html(file_path, chunk_size=500, overlap=100, keywords=None, section_headers=None):
    ...
    section_headers = section_headers or [
        "risk factors", "legal proceedings", "litigation", "regulatory", "compliance"
    ]
    # Find section starts
